Contributing to gcoin Core
============================

The gcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the gcoin Core project, and is not to be
confused with overall gcoin Network Protocol consensus changes.

Whether a pull request is merged into gcoin Core rests with the project merge
...
Patches that change gcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the gcoin consensus, it must have been
...
The project leader is the release manager for each gcoin Core release.
