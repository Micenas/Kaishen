Contributing to kaishen Core
============================

The kaishen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the kaishen Core project, and is not to be
confused with overall kaishen Network Protocol consensus changes.

Whether a pull request is merged into kaishen Core rests with the project merge
...
Patches that change kaishen consensus rules are considerably more involved than
...
Where a patch set proposes to change the kaishen consensus, it must have been
...
The project leader is the release manager for each kaishen Core release.
