...
This means one can have an always-on kaishend instance running, and another local kaishend/kaishen-qt instance which connects to this node and receives blocks from it.
