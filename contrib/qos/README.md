...
This means one can have an always-on gcoind instance running, and another local gcoind/gcoin-qt instance which connects to this node and receives blocks from it.
