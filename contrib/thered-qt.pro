...
RESOURCES += src/qt/gcoin.qrc src/qt/gcoin_locale.qrc

TRANSLATIONS += src/qt/locale/gcoin_bg.ts \
                src/qt/locale/gcoin_de.ts \
                src/qt/locale/gcoin_en.ts \
                src/qt/locale/gcoin_es.ts \
                src/qt/locale/gcoin_fi.ts \
                src/qt/locale/gcoin_fr.ts \
                src/qt/locale/gcoin_it.ts \
                src/qt/locale/gcoin_ja.ts \
                src/qt/locale/gcoin_pl.ts \
                src/qt/locale/gcoin_pt.ts \
                src/qt/locale/gcoin_ru.ts \
                src/qt/locale/gcoin_sk.ts \
                src/qt/locale/gcoin_sv.ts \
                src/qt/locale/gcoin_vi.ts \
                src/qt/locale/gcoin_zh_CN.ts \
                src/qt/locale/gcoin_zh_TW.ts
