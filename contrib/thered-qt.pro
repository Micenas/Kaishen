...
RESOURCES += src/qt/kaishen.qrc src/qt/kaishen_locale.qrc

TRANSLATIONS += src/qt/locale/kaishen_bg.ts \
                src/qt/locale/kaishen_de.ts \
                src/qt/locale/kaishen_en.ts \
                src/qt/locale/kaishen_es.ts \
                src/qt/locale/kaishen_fi.ts \
                src/qt/locale/kaishen_fr.ts \
                src/qt/locale/kaishen_it.ts \
                src/qt/locale/kaishen_ja.ts \
                src/qt/locale/kaishen_pl.ts \
                src/qt/locale/kaishen_pt.ts \
                src/qt/locale/kaishen_ru.ts \
                src/qt/locale/kaishen_sk.ts \
                src/qt/locale/kaishen_sv.ts \
                src/qt/locale/kaishen_vi.ts \
                src/qt/locale/kaishen_zh_CN.ts \
                src/qt/locale/kaishen_zh_TW.ts
