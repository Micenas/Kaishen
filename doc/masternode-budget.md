...
kaishen now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<kaishen_address\> \<monthly_payment_kaishen\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ kaishen, _12_ times over the course of a year totaling _24000_ kaishen.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<kaishen_address\> \<monthly_payment_kaishen\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` kaishen.
 ...
 * vote-many          - Vote on a kaishen initiative
 * vote-alias         - Vote on a kaishen initiative
 * vote               - Vote on a kaishen initiative/budget
