...
In order to support loading of multiple wallets in kaishen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kaishen.cpp.
...
Changes to kaishen.cpp
----------------------
kaishen.cpp is the entry point into kaishen-qt, and as such, will require some minor modifications to provide hooks for
