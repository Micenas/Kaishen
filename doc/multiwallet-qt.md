...
In order to support loading of multiple wallets in gcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gcoin.cpp.
...
Changes to gcoin.cpp
----------------------
gcoin.cpp is the entry point into gcoin-qt, and as such, will require some minor modifications to provide hooks for
