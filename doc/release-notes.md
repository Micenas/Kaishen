gcoin Core version 2.3.0 is now available from:

  <https://github.com/gcoin-project/gcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/gcoin-project/gcoin/issues>

Compatibility
==============

gcoin Core is extensively tested on multiple operating systems using
...
gcoin Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) gcoin MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode gcoin address
...
gcoin Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for gcoin (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with gcoin (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/gcoin-project-translations/).
