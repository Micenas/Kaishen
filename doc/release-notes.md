kaishen Core version 2.3.0 is now available from:

  <https://github.com/kaishen-project/kaishen/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/kaishen-project/kaishen/issues>

Compatibility
==============

kaishen Core is extensively tested on multiple operating systems using
...
kaishen Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) kaishen MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode kaishen address
...
kaishen Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for kaishen (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with kaishen (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/kaishen-project-translations/).
