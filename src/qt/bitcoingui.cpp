                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("G-Coin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About gcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about gcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a gcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the gcoin Core help message to get a list with possible gcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("gcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("gcoin Core"); // default title
