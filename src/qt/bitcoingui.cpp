                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kaishen Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a kaishen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kaishen: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About kaishen Core"), this);
    aboutAction->setStatusTip(tr("Show information about kaishen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for kaishen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your kaishen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified kaishen addresses"));
    ...
    openAction->setStatusTip(tr("Open a kaishen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the kaishen Core help message to get a list with possible kaishen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("kaishen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kaishen network", "", count));
}
...
{
    QString strTitle = tr("kaishen Core"); // default title
