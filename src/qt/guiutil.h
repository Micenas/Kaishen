...
/** Utility functions used by the kaishen Qt UI.
 */
namespace GUIUtil
{
...
// Render kaishen addresses in monospace font
...
// Parse "kaishen:" URI into recipient object, return true on successful parsing
